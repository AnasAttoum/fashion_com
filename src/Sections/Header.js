            ...
            <div className='d-flex justify-content-around align-items-center' style={{height:'65px'}}>
                ...
                <span className={styles.responsive}>
                    ...
                    <div className={styles.list}>
                        <span className='mx-4'>S h o p</span>
                        <span className='mx-4'>M e n</span>
                        <span className='mx-4'>W o m e n</span>
                        <span className='mx-4'>C o m b o s</span>
                        <span className='mx-4'>J o g g e r s</span>
                    </div>
                </span>
