const products = [
    ...
    },
    {
        ...
        type: 'women', option: ['top','plainTShirt'], rating: '3.5', comment: '183',
        colors: {
    ...
    },
    {
        ...
        type: 'men', option: ['top','printedTShirt'], rating: '2', comment: '19',
        colors: {
    ...
    },
    {
        ...
        type: 'men', option: ['top','plainTShirt'], rating: '3', comment: '56',
        colors: {
    ...
    },
    {
        ...
        type: 'men', option: ['top','plainTShirt'], rating: '4', comment: '23',
        colors: {
    ...
    },
    {
        ...
        type: 'men', option: ['top','printedTShirt','fullSleeveTShirt'], rating: '4', comment: '213',
        colors: {
    ...
    },
    {
        ...
        type: 'men', option: ['pants'], rating: '4', comment: '213',
        colors: {
    ...
    },
    {
        ...
        colors: {
            ...
            'red': { color: '#f00', size: ['S', 'M', 'XL'], mainPic: '/Images/Products/Men/7/Color3/618he6dmbpL._AC_SX569_.jpg', pics: [], sale: '0' }
        },
