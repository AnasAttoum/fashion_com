const products = [
    ...
    },
    {
        ...
        type: 'women', option: ['dress'],
        rating: 3.16, num: 6, ratingDetails: { '0': 4, '1': 5, '2': 2, '3': 3, '4': 4, '5': 1 },
        comments: [[ '0', 'OMG..great store !!! Found this store while visiting the UK.. what a find -nice clothing/well made/great prices. I never find anything I Iike in US plus size stores but I could have filled another suitcase in Yours* Will be shopping on this site from now on... please come to the US !!!'], ['1', 'I love the clothes from this website!! I am so glad I found them.....everything has been spot on, fits wonderfully, styles are trendy and lots to choose from!! Thanks for being here for us!!!'], ['2', 'I love these clothes!! I love the fit!!! I love the price!!! I am on my 3rd order from you!! I too was skeptical because you were international.. My order was here within a week and when I pulled out the clothes and tried them on.. I was skeptical no more. Keep those high low tops coming and thank you for making mje look great at work!!!'], ['3', 'I can’t even express how excited I was when your delivery arrived. Such well made, adorable clothing, the sizing is amazing, the pants fit so very well which is saying a lot when you are over a size US 24, even the undies fit so well!!! Amazing. I’m ordering again right now. Thank you! Please bring brick and mortar stores to the United States!!!!' ]],
        colors: {
            'white': { color: 'white', size: ['S', 'M', 'XL'], mainPic: '/Images/Products/Women/2/Cute Spaghetti Straps V Neck Knee Length Short Prom Dress, Homecoming Dress H1011.jpg', pics: ['/Images/Products/Women/2/White-Satin-Spaghetti-Straps-Short-Mini-White-V-neck-Homecoming-Dresses-RJS103-Rjerdress-1491.webp', '/Images/Products/Women/2/White-Satin-Spaghetti-Straps-Short-Mini-White-V-neck-Homecoming-Dresses-RJS103-Rjerdress-4273.webp'], sale: '0' }
        },
    ...
    },
    {
        ...
        type: 'women', option: ['top', 'plainTShirt', 'fullSleeveTShirt'],
        rating: 3.57, num: 7, ratingDetails: { '0': 2, '1': 5, '2': 4, '3': 3, '4': 4, '5': 5, '6': 2 },
    ...
    },
    {
        ...
        type: 'women', option: ['pants'],
        rating: 4.50, num: 2, ratingDetails: { '0': 4, '1': 5 },
        comments: [[ '0', 'I absolutely adore the trendy styles this store offers. The clothes fit so well and they look amazing on a curvy figure. I really appreciate this option and the quality of the goods is so great that I will order product in the future. Thank you so much for making me feel beautiful!' ]],
        colors: {
            'black': { color: 'black', size: ['S', 'M', 'XL'], mainPic: '/Images/Products/Women/5/Solid High Waist Pants, Casual Belted Wide Leg Pants, Women’s Clothing - Temu.jpg', pics: ['/Images/Products/Women/5/61sQM+k3KTL._AC_SX466_.jpg', '/Images/Products/Women/5/61MRKP3v-LL._AC_SX569_.jpg'], sale: '30' }
        },
    ...
    },
    {
        ...
        type: 'men', option: ['jacket'],
        rating: 3.5, num: 4, ratingDetails: { '0': 2, '1': 5, '2': 4, '3': 3 },
    ...
    },
    {
        ...
        type: 'men', option: ['top', 'plainTShirt'],
        rating: 4.5, num: 6, ratingDetails: { '0': 5, '1': 5, '2': 4, '3': 3, '4': 5, '5': 5 },
        comments: [[ '0', 'I have ordered and received several items now, and I have to say, I am in love with this store!!!! Everything I have received fit perfectly, and is good quality. I ordered clothes in my size and they were true to size! I would not hesitate to shop this site again, and I tell all of my friends and family to shop this site too! '], ['1', 'Just received my order & am thrilled with everything I purchased! and the shipping was awesome it took 3 days best yet! i will shop again thanks you.' ]],
        colors: {
    ...
    },
    {
        ...
        comments: [[ '0', 'I absolutely adore the trendy styles this store offers. The clothes fit so well and they look amazing on a curvy figure. I really appreciate this option and the quality of the goods is so great that I will order product in the future. Thank you so much for making me feel beautiful!' ]],
        colors: {
            'white': { color: 'white', size: ['S', 'M', 'XL'], mainPic: '/Images/Products/Men/4/photo_2024-07-10_16-17-55.jpg', pics: ['/Images/Products/Men/4/wahts-polos-477-636.jpg', '/Images/Products/Men/4/wahts-polos-477-6361.jpg'], sale: '30' }
        },
...
export default function Products(state = products, action) {
    switch (action.type) {
        case 'RATING':
            return state.map(element => {
                if (element.id === action.payload.id) {
                    const newNum = element.num + 1
                    const x = (Object.values(element.ratingDetails).reduce((acc, element) => {
                        return acc + element
                    }) + action.payload.myRating) / newNum
                    return { ...element, rating: x.toFixed(2), num: newNum, ratingDetails: { ...element.ratingDetails, 'new': action.payload.myRating } }
                }
                else {
                    return element
                }
        ...
        case 'ADD_COMMENT':
            return state.map(element => {
                if (element.id === action.payload.id) {
                    return { ...element, comments: [ ...element.comments, [action.payload.userId, action.payload.comment] ] }
                }
                else {
                    return { ...element }
                }
